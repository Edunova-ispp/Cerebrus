...
public interface ActividadAlumnoRepository extends JpaRepository<ActividadAlumno, Long> {
    ...
    Optional<ActividadAlumno> findFirstByAlumnoIdAndActividadIdOrderByIdDesc(Long alumnoId, Long actividadId);

    default Optional<ActividadAlumno> findByAlumnoIdAndActividadId(Long alumnoId, Long actividadId) {
        return findFirstByAlumnoIdAndActividadIdOrderByIdDesc(alumnoId, actividadId);
    }
