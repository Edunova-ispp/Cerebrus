...
public interface CursoService {
    Curso crearCurso(String titulo, String descripcion, String imagen, String codigoPersonalizado, Boolean visibilidad);
    ...
    Curso actualizarCurso(Long id, String titulo, String descripcion, String imagen, String codigoPersonalizado, Boolean visibilidad);
